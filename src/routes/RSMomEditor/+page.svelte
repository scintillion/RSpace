<script lang="ts">
	...
	// 	'Ev:Event|Click|Enter|Exit|DblClick|Swipe|Drop|Drag|',
	// 	'Rt:Return|Ok|Fail|Equal|Unequal|Queue|',
	// 	'Td:TileDef|Tile|LnEdit|TxtEdit|Btn|Img|Video|'

	// ]
    const list = new RS1.RSr(rString);
	// const listK = list.K;
